# My4S – программа-конструктор для создания web‑приложений (ERP, CRM и др.), аналогичных BAS, 1С8 и другим системам.
...
- **Администрирование:** Firebird Editor
- Pro My4S может стать отличным инструментом для малого и среднего бизнеса,
особенно если вам нужна гибкая и бесплатная ERP/CRM система.
--- ## Возможности:
 1. **Управление финансами и бухгалтерией** Настройка регистров для учета доходов, расходов, налогов. Встроенные оборотно‑сальдовые ведомости для анализа бюджета.
 2. **Учет складских запасов** Ведение учета товаров, отслеживание остатков, автоматизация закупок и анализ продаж.
 3. **Управление клиентами и продажами** Справочники контрагентов, документооборот, автоматизация выставления счетов и анализ продаж.
 ...
 5. **Гибкая настройка** Добавление новых модулей и функций, расширение отчетности, интеграция с другими сервисами.
  --- ## Документация -
📄 [Help4s_en.pdf](Help4s_en.pdf) — описание на английском -
📄 [Help4s_ua.pdf](Help4s_ua.pdf) — описание на украинском
⚙️ В файле `Distrib_My4s.zip` находится всё необходимое для сборки программы. Следуйте инструкциям в Help‑файле.
--- ## Контакты:
     ✉️ Автор: sergey2429@i.ua
--- ## 💖 Поддержать проект Если проект полезен, вы можете поддержать его напрямую через
...
--- ## Лицензия MIT License — см. файл [LICENSE](LICENSE.md).
